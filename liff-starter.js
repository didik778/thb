    ...
    if (!tipe) {
        ...
        document.getElementById('textx').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjQ2MDExODM1LU5NZVd2UjlKP3R5cGU9Zm90ZXh0JnRleHQ9SGFjayUyMEJvdA==')
        ...
        document.getElementById('imagex').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjQ2MDExODM1LU5NZVd2UjlKP3R5cGU9Zm9pbWFnZSZpbWc9aHR0cHM6Ly9pLmliYi5jby9IdFBrblo4LzE1NDk4MDUyOTYxMTQuanBnJw==')
        ...
        document.getElementById('videox').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjQ2MDExODM1LU5NZVd2UjlKP3R5cGU9dmlkZW8mb2N1PWh0dHBzOi8vdGlueXVybC5jb20veThvZzNvcjUmcGl1PWh0dHBzOi8vaS5pYmIuY28vSHRQa25aOC8xNTQ5ODA1Mjk2MTE0LmpwZw==')
        ...
        document.getElementById('audiox').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('bGluZTovL2FwcC8xNjQ2MDExODM1LU5NZVd2UjlKP3R5cGU9YXVkaW8mbGluaz1odHRwczovL3BsYXRlbGV0cy5mdW4vcHVibGljL3NvdW5kcy9tdXNpYy5tcDM=')
        ...
        document.getElementById('stickerx').addEventListener('click', function () {
            ...
            liff.sendMessages([{
                ...
                text: atob('Tm8gQW5pbWF0aW9uOgpsaW5lOi8vYXBwLzE2NDYwMTE4MzUtTk1lV3ZSOUo/dHlwZT1zdGlja2VyJnN0az1ub2FuaW0mc2lkPTIyMTQxMzAwJnBrZz0xNjc3NzA1CgpXaXRoIEFuaW1hdGlvbjoKbGluZTovL2FwcC8xNjQ2MDExODM1LU5NZVd2UjlKP3R5cGU9c3RpY2tlciZzdGs9YW5pbSZzaWQ9NjY0NDg1NjAmcGtnPTQxNzc1ODg=')
